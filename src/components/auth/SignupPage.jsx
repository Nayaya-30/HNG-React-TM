			...
			>
				...
				<div className="mb-4">
					...
					{passwordStrength.label && (
						<div className="mt-2">
							...
							<p
								className={`text-sm mt-1 font-medium ${passwordStrength.color.includes('red')
									? 'text-red-500'
				...
				<div className="w-full flex flex-col sm:flex-row gap-3">
					<button
						...
						className="w-full sm:w-1/2 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-md transition-transform transform active:scale-95"
					>
