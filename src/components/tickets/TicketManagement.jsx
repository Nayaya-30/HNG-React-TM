...
const TicketManagementApp = ({
	...
	// validate a given form object (used by the form component)
	const validate = (data) => {
		const newErrors = {};
	...
	// This handler is called by the TicketForm and receives the current form data.
	// We intentionally accept the form data here so the form can perform inline validation
	// and then hand over the validated payload for creation/update.
